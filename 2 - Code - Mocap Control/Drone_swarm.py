...
take_off_height = .5
drone1_takeoff_thread = TakeoffThread(drone1_connection, take_off_height, accuracy)
drone2_takeoff_thread = TakeoffThread(drone2_connection, take_off_height, accuracy)
